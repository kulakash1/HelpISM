 ...
 * @author hp
 */
public class Gynecalogist extends javax.swing.JFrame {

    /**
     * Creates new form Gynecalogy
     */
    public Gynecalogist() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GENERAL PHYSICIST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String qry = "Insert into appointment values('GYNECOLOGIST','2019-"+month+"-"+day+"','"+time+":00:00');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gynecalogist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gynecalogist().setVisible(true);
            }
        });
    }
