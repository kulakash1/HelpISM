 ...
 * @author hp
 */
public class Optician extends javax.swing.JFrame {

    /**
     * Creates new form Optician
     */
    public Optician() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String qry = "Insert into appointment values('OPTICIAN','2019-"+month+"-"+day+"','"+time+":00:00');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Optician.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
