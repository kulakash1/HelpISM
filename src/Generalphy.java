 ...
 * @author hp
 */
public class Generalphy extends javax.swing.JFrame {

    /**
     * Creates new form Generalphy
     */
    public Generalphy() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String qry = "Insert into appointment values('GENERAL PHYSICIST','2019-"+month+"-"+day+"','"+time+":00:00');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Generalphy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Generalphy().setVisible(true);
            }
        });
    }
